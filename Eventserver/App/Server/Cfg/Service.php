...
class Service{
     ...
     */
    const DAEMON_UID=999;
    
   /**
    * user group ID of event service.
    */
    const DAEMON_GID=999;
    ...
    */
     ...
     * @var boolean
     */
    const ENABLE_IN_SUCCESS_LOG = false;
     ...
     * @var string
     */
    const TUBE_EVENT_CENTER_MESSAGES = 'main_queue';
    /**
     ...
     * @var int
     */
    const MAX_MESSAGE_DELIVERER_WORKER_NUM = 80;
//    const MAX_MESSAGE_DELIVERER_WORKER_NUM = 70;

    /**
     * maxium number of worker processes for re-pushing messages to subscribers
     * @var int
     */
    const MAX_MESSAGE_RE_DELIVERER_WORKER_NUM = 100;
     ...
     * *required*
     */
    public static $openServices = array('Broadcast::Send',
                );
